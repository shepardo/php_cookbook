...
The LittleCalendar class shown in Example 3-31 prints out a month’s calendar, similar
to the Unix cal program. Example 3-30 shows how you can use the class, including
default styles for its layout.
*/
